...
exports.getBankNiftyDataDailyStrangle200 = async (req, res, next) => {
...
exports.bankNiftyOpensDailyStrangle200 = async (req, res, next) => {
...
exports.bankNiftyClosesDailyStrangle200 = async (req, res, next) => {
    const sheet = await loadSheet(0);
