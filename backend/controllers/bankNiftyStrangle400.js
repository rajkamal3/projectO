...
exports.getBankNiftyDataDailyStrangle400 = async (req, res, next) => {
        ...
        .then(res => {
            ...
            optionChainDailyStrangle.map(option => {
                if (option.atm === true) {
                    ...
                    const otmCe = optionChainDailyStrangle[atm + 2];
                    const otmPe = optionChainDailyStrangle[atm - 2];
...
exports.bankNiftyOpensDailyStrangle400 = async (req, res, next) => {
...
exports.bankNiftyClosesDailyStrangle400 = async (req, res, next) => {
    const sheet = await loadSheet(1);
