...
exports.getBankNiftyDataDailyStrangle800 = async (req, res, next) => {
        ...
        .then(res => {
            ...
            optionChainDailyStrangle.map(option => {
                if (option.atm === true) {
                    ...
                    const otmCe = optionChainDailyStrangle[atm + 4];
                    const otmPe = optionChainDailyStrangle[atm - 4];
...
exports.bankNiftyOpensDailyStrangle800 = async (req, res, next) => {
...
exports.bankNiftyClosesDailyStrangle800 = async (req, res, next) => {
    const sheet = await loadSheet(1);
